...
import de.itscope.it.AbstractIntegrationTest
import it.infra.WebSocketChatClient
...
class AiChatWebSocketTest : AbstractIntegrationTest() {
    private val wsClient: WebSocketChatClient =
        WebSocketChatClient(port = server.port)
